...
# Just an example of configurations!

"""
    In every project, it requires a profile dict like
        profile = {
        "UNIVERSAL_PATH":"/home/vivalavida/workspace/alpha/UNIVERSAL", # not required
        "project_path": os.getcwd(),
        "corpora_path": "/home/vivalavida/massive_data/data/wiki/EnDeHi_6k",
        "GPU":2
        }.

    The profile dict will provide the value for keys in language modeling block. However, you can mannully set
    those values instead of the profile dict.
